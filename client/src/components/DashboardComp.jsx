...
import { IoArrowUp, IoDocumentText } from 'react-icons/io5'
...
function DashboardComp() {
    ...
    return (
        <div className='p-3 md:mx-auto'>
            <div className="flex flex-wrap gap-4 justify-center">
                ...
                <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
                    <div className="flex justify-between">
                        ...
                        <IoDocumentText className='bg-lime-600 text-white rounded-full text-5xl p-3 shadow-lg' />
                    </div>
            ...
            <div className="flex flex-wrap gap-4 justify-center mx-auto py-3 mt-2">
