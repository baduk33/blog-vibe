...
function DashComments() {
    ...
    return (
        <div className=' 3/4 table-auto overflow-x-auto md:mx-auto p-3 scrollbar scrollbar-track-slate-100 scrollbar-thumb-slate-300 dark:scrollbar-track-slate-700 dark:scrollbar-thumb-slate-500'>
                    ...
                    <Table hoverable className='shadow-md'>
                        ...
                        <Table.Body className='divide-y-2'>
                            {comments.map((comment) => (
                                <Table.Row key={comment._id} className='bg-white dark:bg-gray-800 dark:border-gray-700'>
                                    <Table.Cell>
