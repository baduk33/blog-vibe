            ...
            <Table.Body className='divide-y-2'>
              {userPosts.map((post) => (
                <Table.Row key={post._id} className='bg-white dark:bg-gray-800 dark:border-gray-700'>
                  ...
                  <Table.Cell>
                    <Link to={`/update-post/${post._id}`} className='text-teal-500 dark:text-teal-300 hover:underline'>
                      <span>
                        Edit
                      </span>
                    </Link>
      ...
      <Modal show={showModal} onClose={() => setShowModal(false)} popup size='md'>
        ...
        <Modal.Body>
          <div className="text-center">
            ...
            <h3 className='text-lg mb-4 text-gray-500 dark:text-gray-400'>Are you sure you want to delete this post?</h3>
